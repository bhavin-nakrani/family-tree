 ...
 * Generated for Laravel 5.8.7 on 2019-04-09 06:55:00.
 *
...
namespace Luthfi\FormField { 
    ...
    class FormFieldFacade {
        ...
        {
                        /** @var \Luthfi\FormField\FormField $instance */
         ...
         *
         * @param \Luthfi\FormField\[type] $name Select field name.
         * @param array|\Luthfi\FormField\Collection $selectOptions Select options.
         * @param array $options Select input attributes.
         * @return string Generated select input form field.
         * @static 
         */ 
        public static function select($name, $selectOptions, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->select($name, $selectOptions, $options);
        }
        
        /**
         * Multi-select/dropdown field wrapped with form-group bootstrap div.
         *
         * @param \Luthfi\FormField\[type] $name Select field name which will become array input.
         * @param array|\Luthfi\FormField\Collection $selectOptions Select options.
         * @param array $options Select input attributes.
         * @return string Generated multi-select input form field.
         * @static 
         */ 
        public static function multiSelect($name, $selectOptions, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->multiSelect($name, $selectOptions, $options);
        }
         ...
         *
         * @param \Luthfi\FormField\[type] $name Radio field name.
         * @param array|\Luthfi\FormField\Collection $radioOptions Radio options.
         * @param array $options Radio input attributes.
         * @return string Generated radio input form field.
         * @static 
         */ 
        public static function radios($name, $radioOptions, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->radios($name, $radioOptions, $options);
        }
         ...
         * @static 
         */ 
        public static function checkboxes($name, $checkboxOptions, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->checkboxes($name, $checkboxOptions, $options);
        }
         ...
         * @static 
         */ 
        public static function textDisplay($name, $value, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->textDisplay($name, $value, $options);
        }
         ...
         * @static 
         */ 
        public static function formButton($form_params = array(), $button_label = 'x', $button_options = array(), $hiddenFields = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->formButton($form_params, $button_label, $button_options, $hiddenFields);
        }
         ...
         * @static 
         */ 
        public static function delete($form_params = array(), $button_label = 'x', $button_options = array(), $hiddenFields = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->delete($form_params, $button_label, $button_options, $hiddenFields);
        }
         ...
         * @static 
         */ 
        public static function arrays($name, $fieldKeys, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->arrays($name, $fieldKeys, $options);
        }
         ...
         * @static 
         */ 
        public static function price($name, $options = array())
        {
                        /** @var \Luthfi\FormField\FormField $instance */
                        return $instance->price($name, $options);
        }
...
namespace  { 
    ...
    class FormField extends \Luthfi\FormField\FormFieldFacade {}
